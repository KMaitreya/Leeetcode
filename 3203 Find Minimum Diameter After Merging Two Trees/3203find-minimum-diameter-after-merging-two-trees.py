...
#         key1, hmap1=counter(edges1)
#         key2, hmap2=counter(edges2)
...
#             if node not in hmap:
#                 return 0
#             return max(depth(child, hmap) for child in hmap[node])+1

#         return depth(key1, hmap1)+depth(key2, hmap2)+1
